...
interface StaffMealAttendanceProps {
    staff: any;
}

const StaffMealAttendance: React.FC<StaffMealAttendanceProps> = ({ staff }) => {
    const theme = useTheme();
    const mealAttendances = staff?.mealAttendances || [];
            ...
            <Fade in={true} timeout={500}>
                <Box sx={{ p: 3, textAlign: "center" }}>
                    <Alert severity="info" sx={{ borderRadius: 2 }}>
                        No meal attendance records found for this staff member.
                    </Alert>
                </Box>
            </Fade>
        );
...
export default StaffMealAttendance;